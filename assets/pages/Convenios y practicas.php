...
<head>
    ...
    <title>Convenios y Prácticas</title>
</head>
<body>
    ...
    <header class="header basic__style" id="header__areas">
        ...
        <div class="header__portada">
            ...
            <div class="header__titles">
                <h1>Convenios y Prácticas</h1>
                <p>Todo lo que debes saber de las prácticas</p>
            </div>
        </div>
    </header>

    <main class= "mainc">
        <h3 class="requisitos">Convenios Institucionales</h3>

        <div class="slider">
                <div class="slideres">
                    <div class="slide">
                        <img src="/assets/img/Icons/LogoCotemag.png" alt="">
                        <img src="/assets/img/Icons/BMN_cam_3-removebg-preview.png" alt="">
                        <img src="/assets/img/Icons/Logo_BMN-removebg-preview.png" alt="">
                        <img src="/assets/img/Icons/Centuries mR.png" alt="">
                        <img src="/assets/img/Icons/logo 4 B.png" alt="">
            ...
            <div class="slider slider2">
                ...
                <h3 class="requisitos">Requisitos de practicas</h3>
            ...
            <div class="accordion" id="accordionPanelsStayOpenExample2">
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            ...
                            <h2 class="my-3 color1">Anexsos de Prácticas</h2>
                            </button>
                        </h2>
